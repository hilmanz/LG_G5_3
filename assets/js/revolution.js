        ...
        var createThumbs = function(container,opt) {
            ...
            container.find('>ul:first >li').each(function(i) {
                            ...
                            if (li.data('thumb') !=undefined)
								...
								var path=li.find("img:first").attr('path');


                            bullets.append('<div class="bullet thumb" style="background-color:'+bgcolor+';position:relative;width:'+opt.thumbWidth+'px;height:'+opt.thumbHeight+'px;background-image:url('+path+') !important;background-size:cover;background-position:center center;"></div>');
                            var bullet= bullets.find('.bullet:first');
                });
